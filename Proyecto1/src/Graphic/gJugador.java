...
public class gJugador extends gEntidad {
	...
	public gJugador(int velocidad,Bomberman bom, int x, int y,Tablero tablero,gTablero gt) {
		...
		this.mMuerte = new ImageIcon(this.getClass().getResource("/BattleCity/explotion.png"));
		movi.run();
	}
	...
	public void morir(){
		...
		mPosicion.x=32;
		mPosicion.y=32;
		this.mPosicion.setLocation(this.mPosicion.x,this.mPosicion.y);
		bomberman.morir();
		//if (vidas==0){
		//	super.muerte();
		//}
