...
public class gJugador extends gEntidad {
	...
	public gJugador(int velocidad, Bomberman bom, int x, int y,
			Tablero tablero, gTablero gt) {

		super(velocidad, x, y);

		dejarBomba = java.applet.Applet.newAudioClip(getClass().getResource(
				"/Sonidos/PonerBomba.wav"));
