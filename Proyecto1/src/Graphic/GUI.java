...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		label.setIcon(new ImageIcon(GUI.class.getResource("/imagenes/Banner.png")));
	...
	public void fin(int e){
		...
		if(e==0){
		sonido.stop();
		sonido=java.applet.Applet.newAudioClip(getClass().getResource("/Sonidos/pierde.wav"));
		sonido.play();}
		else if(e==1){
			sonido.stop();
			sonido=java.applet.Applet.newAudioClip(getClass().getResource("/Sonidos/fin.wav"));
			sonido.play();
		}
